...
{
    //读出行扫描状态
    Key_row[0] = HAL_GPIO_ReadPin(GPIOB,GPIO_PIN_12)<<3;
    Key_row[0] = Key_row[0] | (HAL_GPIO_ReadPin(GPIOB,GPIO_PIN_13)<<2);
    Key_row[0] = Key_row[0] | (HAL_GPIO_ReadPin(GPIOB,GPIO_PIN_14)<<1);
    Key_row[0] = Key_row[0] | (HAL_GPIO_ReadPin(GPIOB,GPIO_PIN_15));
